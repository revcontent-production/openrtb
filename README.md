# openrtb [![Go Reference](https://pkg.go.dev/badge/github.com/revcontent-production/openrtb/v7.svg)](https://pkg.go.dev/github.com/revcontent-production/openrtb/v7) [![Test](https://github.com/prebid/openrtb/actions/workflows/test.yml/badge.svg)](https://github.com/prebid/openrtb/actions/workflows/test.yml)
...
```bash
go get -u "github.com/revcontent-production/openrtb/v7/..."
```

```go
import (
	openrtb2 "github.com/revcontent-production/openrtb/v7/openrtb2"

	openrtb3 "github.com/revcontent-production/openrtb/v7/openrtb3"
	adcom1 "github.com/revcontent-production/openrtb/v7/adcom1"

	native1 "github.com/revcontent-production/openrtb/v7/native1"
	nreq "github.com/revcontent-production/openrtb/v7/native1/request"
	nres "github.com/revcontent-production/openrtb/v7/native1/response"
)
```
...
## Documentation ([pkg.go.dev](https://pkg.go.dev/github.com/revcontent-production/openrtb/v7))
