# openrtb [![Go Reference](https://pkg.go.dev/badge/github.com/revcontent-production/openrtb.svg)](https://pkg.go.dev/github.com/revcontent-production/openrtb) [![Test](https://github.com/prebid/openrtb/actions/workflows/test.yml/badge.svg)](https://github.com/prebid/openrtb/actions/workflows/test.yml)
...
```bash
go get -u "github.com/revcontent-production/openrtb/..."
```

```go
import (
	openrtb2 "github.com/revcontent-production/openrtb/openrtb2"

	openrtb3 "github.com/revcontent-production/openrtb/openrtb3"
	adcom1 "github.com/revcontent-production/openrtb/adcom1"

	native1 "github.com/revcontent-production/openrtb/native1"
	nreq "github.com/revcontent-production/openrtb/native1/request"
	nres "github.com/revcontent-production/openrtb/native1/response"
)
```
...
## Documentation ([pkg.go.dev](https://pkg.go.dev/github.com/revcontent-production/openrtb))
